...
namespace WebIdentityApi.Controllers
{
    ...
    public class IdentityController : ControllerBase
    {
        ...
        private readonly IIdentityPasswordService _passwordService;
        public IdentityController(IUserRepository userManager, IIdentityPasswordService passwordService)
        {
